...
function cyberchimps_slider_lite_page_options()
{
    ...
    $page_fields	= array(
        ...
        array(
            ...
            'class'	=> '',
            'name'	=> __('Slide One Image', 'primo')
        ),
        array(
            'type'	=> 'text',
            'id'	=> 'cyberchimps_slider_lite_slide_one_url',
            'class'	=> '',
            'name'	=> __('Slide One Link', 'primo'),
        ...
        array(
            ...
            'class'	=> '',
            'name'	=> __('Slide Two Image', 'primo')
        ),
        array(
            'type'	=> 'text',
            'id'	=> 'cyberchimps_slider_lite_slide_two_url',
            'class'	=> '',
            'name'	=> __('Slide Two Link', 'primo'),
            'std'	=> esc_url(home_url())
        ),
        array(
            'type'	=> 'single_image',
            ...
            'class'	=> '',
            'name'	=> __('Slide Three Image', 'primo')
        ),
        array(
            'type'	=> 'text',
            'id'	=> 'cyberchimps_slider_lite_slide_three_url',
            'class'	=> '',
            'name'	=> __('Slide Three Link', 'primo'),
            'std'	=> esc_url(home_url())
        )
    ...
    $page_config = array(
        ...
        'title'				=> __('Slider Lite Options', 'primo'), // meta box title
